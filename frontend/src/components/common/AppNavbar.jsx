    ...
    <header className="sticky top-3 sm:top-4 z-50 w-full px-3 sm:px-6 pointer-events-none transition-all duration-200">
      <div className="max-w-6xl mx-auto curved-navbar px-4 sm:px-6 py-2.5 sm:py-3 flex items-center justify-between pointer-events-auto shadow-md">
        ...
        <Link to="/" className="flex items-center gap-2 sm:gap-2.5 group shrink-0">
          <div className="w-8 sm:w-9 h-8 sm:h-9 rounded-full bg-gradient-to-br from-[#B45309] to-[#D97706] flex items-center justify-center text-white shadow-sm shadow-[#B45309]/20 group-hover:scale-105 transition-transform">
            <Calendar size={16} className="sm:w-[18px] sm:h-[18px] font-bold" />
          </div>
          <div className="flex items-baseline leading-none">
            <span className="logo-cursive text-2xl sm:text-3xl font-extrabold text-[#B45309] mr-0.5 tracking-normal">Event</span>
            <span className="font-extrabold text-stone-900 text-lg sm:text-xl tracking-tight uppercase">FORGE</span>
          </div>
        </Link>
